...
#Class Exercise
#Read the Excel file - 'ProduceReport.xlsx' that you craeted earlier. Write all the contents of this file to
#'Second Sheet' in the current workbook. Display the Grand Total and Average of 'Amt Sold' and 'Total'
